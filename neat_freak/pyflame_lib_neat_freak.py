...
Usage:
    ...
    from pyflame_<script name> import FlameButton, FlameLabel, FlameSlider...
'''

from lib2to3.pgen2.token import OP
from PySide2 import QtWidgets, QtCore, QtGui
import xml.etree.ElementTree as ET
from typing import Union, List, Dict, Optional, Callable, TypeVar
...
def pyflame_print(script_name: str, message: str, message_type: Optional[str]='message', time=3) -> None:
    '''
...
def pyflame_file_browser(title: str, extension: List[str], default_path: str, select_directory=False, multi_selection=False, include_resolution=False, use_flame_browser=True, window_to_hide=[]) -> Union[str, list]:
    '''
...
def pyflame_resolve_path_tokens(path_to_resolve, PyObject=None, date=None) -> str:
    '''
...
def pyflame_refresh_hooks(script_name: str='') -> None:
    '''
...
class FlameButton(QtWidgets.QPushButton):
    ...
    def __init__(self, button_name: str, connect, button_color: str='normal', button_width: int=150, button_max_width: int=150):
...
class FlameClickableLineEdit(QtWidgets.QLineEdit):
    ...
    def __init__(self, text: str, connect, width: int=150, max_width: int=2000):
...
class FlameLabel(QtWidgets.QLabel):
    ...
    def __init__(self, label_name: str, label_type='normal', label_width=150):
...
class FlameLineEdit(QtWidgets.QLineEdit):
    ...
    def __init__(self, text: str, width=150, max_width=2000):
...
class FlamePasswordWindow(QtWidgets.QDialog):
    ...
    def __init__(self, window_title: str, message: str, user_name=False, parent=None):
...
class FlamePushButton(QtWidgets.QPushButton):
    ...
    def __init__(self, button_name: str, button_checked: bool, connect=None, button_width=150):
...
class FlamePushButtonMenu(QtWidgets.QPushButton):
    ...
    def __init__(self, button_name: str, menu_options: List[str], menu_width=150, max_menu_width=2000, menu_action=None):
...
QtLayout = TypeVar('QtLayout', QtWidgets.QHBoxLayout, QtWidgets.QVBoxLayout, QtWidgets.QGridLayout)
...
class FlameQDialog(QtWidgets.QDialog):
    ...
    def __init__(self, window_title: str, window_layout: QtLayout, window_width: int, window_height: int, window_bar_color: Optional[str]='blue'):
...
class FlameTokenPushButton(QtWidgets.QPushButton):
    ...
    def __init__(self, button_name: str, token_dict: Dict[str, str], token_dest, button_width=150, button_max_width=300):
...
class FlameTreeWidget(QtWidgets.QTreeWidget):
    ...
    def __init__(self, tree_headers: List[str], connect=None, tree_min_width=100, tree_min_height=100):
...
class FlameWindow(QtWidgets.QWidget):
    ...
    def __init__(self, window_title: str, window_layout, window_width: int, window_height: int, window_bar_color='blue'):
